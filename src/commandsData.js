const gitCommands = [
  ...
  },
  {
    ...
    example: 'To filter commit history by author name "John Doe", run:',
  ...
  {
    name: 'git log --stat',
    description: 'Display additional statistics in the commit log.',
  ...
  {
    name: 'git shortlog',
    description: 'Summarize git log output by user.',
